...
<head>
    ...
    <title>Deskripsi Iron Man</title>
...
<div class="IconlyLightArrowLeftCircle" style="width: 100%; height: 100%; position: relative">
    <div class="IconlyLightArrowLeftCircle" style="width: 44px; height: 44px; left: 80px; top: 0px; position: absolute">
        <div class="ArrowLeftCircle" style="width: 33.92px; height: 50px; left: 0px; top: 0px; position: absolute; transform: rotate(90deg); transform-origin: 0 0">
            <a href="daftarfilm.php"><img src="../assets/images/kepala.png" height="50px"></a>
        </div>
    </div>
</div>
...
<div class="DeskripsiIronMan" style="width: 100%; height: 100%; position: relative; background: black">
        <img class="UntitledDesign11" style="width: 500px; height: 888.89px; left: 470px; top: 135px; position: absolute"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                var group1Button = document.querySelector('.Group1');

                group1Button.addEventListener('click', function () {
                    window.location.href = 'kekuatan.php';
                });
            });
        </script>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                var group2Button = document.querySelector('.Group2');

                group2Button.addEventListener('click', function () {
                    window.location.href = 'bajubesi.php';
                });
            });
        </script>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                var group3Button = document.querySelector('.Group1');

                group3Button.addEventListener('click', function () {
                    window.location.href = 'keterampilan.php';
                });
            });
        </script>
