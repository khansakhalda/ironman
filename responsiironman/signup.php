...
<div class="Login" style="width: 100%; height: 100%; position: relative; background: black">
    ...
    <div class="Group34" style="width: 350px; height: 57px; left: 543px; top: 712px; position: absolute">
        ...
        <div class="SignUp" onclick="signUp()" style="width: 110px; height: 33px; left: 122px; top: 9px; position: absolute; color: white; font-size: 30px; font-family: Inder; font-weight: 400; word-wrap: break-word">
        Sign Up
        </div>
